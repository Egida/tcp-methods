...
int ports[] = {80,443}; 
int windows[] = {0,8192,65535,33268,14480,14600,16666,64136,16176,64240,64216,65453,65340,64287,38848,16740,14520,65125,15456};
...
void setup_tcp_header(struct tcphdr *tcph)
{
	...
	tcph->urg = 0;
	tcph->urg_ptr = 0;
	tcph->window = htons(windows[rand_cmwc() % 20]);
	tcph->check = 0;
}
...
int main(int argc, char *argv[])
{
	...
	fprintf(stdout, "Should have used state-full packet inspection based hosting...\n");
